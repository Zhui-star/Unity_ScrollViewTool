...
namespace yoyohan.EnhancedUI.EnhancedScroller
{
    /// <summary>
    ...
    public class EnhancedScroller : MonoBehaviour
    {
        ...
        public EnhancedScrollerCellView GetCellView(EnhancedScrollerCellView cellPrefab)
        {
            ...
            if (cellView.gameObject.activeSelf == false)
        ...
        private void _RecycleCell(EnhancedScrollerCellView cellView)
        {
            ...
            //yoyohan修改原始代码  原始代码有误 为reset the cellView's properties在前 调用在后  造成0的dataIndex有误
        ...
        void Awake()
        {
            ...
            _layoutGroup.childForceExpandHeight = false;//True
